...
function my_keydown(e)
{
	...
	function down()
	{
		...
		{
			ball_y =ball_y+ +block_image_height;
			console.log("alto de la imagen del bloque="bloc_image_height);
	...
	function right()
	{
		...
		{
			ball_x=ball_x - block_image_width;
			console.log("ancho de la imagen del bloque = "+ bñpcl_image_width);
			console.log("Cuando se presione la tecla derecha, X=" +block_image_width);
